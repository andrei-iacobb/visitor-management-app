...
public final class ActivityAdminDashboardBinding implements ViewBinding {
  ...
  private ActivityAdminDashboardBinding(@NonNull LinearLayout rootView, @NonNull ImageView btnBack,
      @NonNull MaterialButton btnRefresh, @NonNull TabLayout tabLayout,
  ...
  public static ActivityAdminDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAdminDashboardBinding((LinearLayout) rootView, btnBack, btnRefresh,
          tabLayout, viewPager);
    }
